...
- [Instructor's Guide](http://software-carpentry.org/v5/novice/teaching/index.html)
...
- [Esri Press | GIS Tutorial for Python Scripting](http://esripress.esri.com/display/index.cfm?fuseaction=display&websiteID=256&moduleID=0)
- [Esri Press | Python Scripting for ArcGIS](http://esripress.esri.com/display/index.cfm?fuseaction=display&websiteID=224&moduleID=0)

training:
- [Esri Training | Python for Everyone](http://training.esri.com/gateway/index.cfm?fa=catalog.webcoursedetail&courseid=2520)
- [Esri Training | Using Python in ArcGIS Desktop 10](http://training.esri.com/gateway/index.cfm?fa=catalog.webCourseDetail&courseID=1868)
- [Esri Training | Creating Python Toolboxes Using ArcGIS 10.1](http://training.esri.com/gateway/index.cfm?fa=catalog.webCourseDetail&courseid=2523)
...
- Git/SVN > Git executable: `C:/Program Files (x86)/Git/bin/git.exe`

...
Finally, you'll be using the best of breed scientific programming tools to keep track changes in the files you create (with **git**) and publish a report to a developer centric online project management interface (**Github**). You'll make this report in a language ('**markdown**) that easily converts to an html web page (and other formats).

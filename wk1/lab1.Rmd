...
From your RStudio courses project (should appear in upper right as "courses" not "esm296-4f"; or simply double click 'H:\github\courses\courses.Rproj` in Windows Explorer to get there), use the Git pane to Commit all new untracked files (which show up with Status yellow "??") in the Commit window. You can select multiple files at once by clicking at the top of the list, holding shift and clicking bottom of list, Stage All. Enter a message (always for a Commit.)

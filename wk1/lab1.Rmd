...
Notice the output is `in_memory/u_001`. That's not a folder. That's the [`in_memory` workspace](http://resources.arcgis.com/en/help/main/10.2/index.html#//002w0000005s000000) so the interim output is not written to disk, but simply kept in memory for your session.

...
Check out the open-source cross-platform equivalent code to accomplish this task in R in [lab2.R](lab2.R). Feel free to open it and try it out yourself. You'll need to run the [wind_country.R](wind_country.R) first. It also outputs plots to an img folder. If we have time I'll gove over the script in class.
...
You can look at a cleaned up version of the script [wind_country.py](wind_country.py).

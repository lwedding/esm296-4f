...
Check out the open-source cross-platform equivalent code to accomplish this task in R in [wind_country.R](wind_country.R). Feel free to open it and try it out yourself. You'll need to run the [r_setup.R](r_setup.R) first. It also outputs plots to an img folder. If we have time I'll gove over the script in class.

...
Notice how in the first instance `%d` is replaced by the value of `j`. But in the second, without a variable and extra `%` outside the string to indicate substitution the string `"slice %d"` is taken literally. So the presence of a % after the string "in_memory\\s_%03d" sets up the string to accept input variables for substitution, ie %03d formatting for the value of j.

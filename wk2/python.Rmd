...
- **Python** programming.
  ...
  - **zero indexing**, so starts at 0.
  
  - **basics**: variable assignment (`=`), comparison (`==`), data types (`str`, `int`, `list`),  iteration (`for`), `import` modules, string formatting and substitution, list comprehensions
  
  - **PythonWin** as an integrated development environment (IDE)
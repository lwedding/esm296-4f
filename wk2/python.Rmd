...
So far the script is calculating the terrestrial wind. Now update the in_countries variable in your script to use the marine exclusive economic zone (EEZ) describe above in the Data section. You'll need to also update the field parameter used previously to define your zones and then join back (ie the field "NAME" does not exist in the EEZ shapefile).
